...
_libraries = {}
_libraries['./build/libcassie_plugin.so'] = ctypes.CDLL('./build/libcassie_plugin.so')
...
cassie_core_sim_alloc = _libraries['./build/libcassie_plugin.so'].cassie_core_sim_alloc
cassie_core_sim_alloc.restype = POINTER_T(struct_CassieCoreSim)
cassie_core_sim_alloc.argtypes = []
cassie_core_sim_copy = _libraries['./build/libcassie_plugin.so'].cassie_core_sim_copy
...
cassie_core_sim_free = _libraries['./build/libcassie_plugin.so'].cassie_core_sim_free
cassie_core_sim_free.restype = None
cassie_core_sim_free.argtypes = [POINTER_T(struct_CassieCoreSim)]
cassie_core_sim_setup = _libraries['./build/libcassie_plugin.so'].cassie_core_sim_setup
...
cassie_core_sim_step = _libraries['./build/libcassie_plugin.so'].cassie_core_sim_step
...
pack_cassie_out_t = _libraries['./build/libcassie_plugin.so'].pack_cassie_out_t
pack_cassie_out_t.restype = None
pack_cassie_out_t.argtypes = [POINTER_T(struct_c__SA_cassie_out_t), POINTER_T(ctypes.c_ubyte)]
unpack_cassie_out_t = _libraries['./build/libcassie_plugin.so'].unpack_cassie_out_t
...
pack_cassie_user_in_t = _libraries['./build/libcassie_plugin.so'].pack_cassie_user_in_t
...
unpack_cassie_user_in_t = _libraries['./build/libcassie_plugin.so'].unpack_cassie_user_in_t
...
process_packet_header = _libraries['./build/libcassie_plugin.so'].process_packet_header
...
udp_init_host = _libraries['./build/libcassie_plugin.so'].udp_init_host
udp_init_host.restype = ctypes.c_int32
udp_init_host.argtypes = [POINTER_T(ctypes.c_char), POINTER_T(ctypes.c_char)]
udp_init_client = _libraries['./build/libcassie_plugin.so'].udp_init_client
...
udp_close = _libraries['./build/libcassie_plugin.so'].udp_close
udp_close.restype = None
udp_close.argtypes = [ctypes.c_int32]
get_newest_packet = _libraries['./build/libcassie_plugin.so'].get_newest_packet
...
wait_for_packet = _libraries['./build/libcassie_plugin.so'].wait_for_packet
...
send_packet = _libraries['./build/libcassie_plugin.so'].send_packet
send_packet.restype = ssize_t
send_packet.argtypes = [ctypes.c_int32, POINTER_T(None), size_t, POINTER_T(struct_sockaddr), socklen_t]
__all__ = \
    ['udp_init_client', 'struct_c__SA_cassie_joint_out_t',
    'elmo_out_t', 'cassie_out_t', 'struct_c__SA_cassie_out_t',
    'struct_c__SA_cassie_leg_out_t', 'cassie_pelvis_in_t',
    'struct_c__SA_cassie_pelvis_out_t',
    'struct_c__SA_vectornav_out_t', 'udp_close', 'ssize_t',
    'cassie_core_sim_copy', 'struct_CassieCoreSim', 'socklen_t',
    'struct_c__SA_radio_out_t', 'struct_c__SA_cassie_leg_in_t',
    'pack_cassie_out_t', 'cassie_user_in_t', 'struct_c__SA_elmo_in_t',
    'pack_cassie_user_in_t', 'send_packet', 'cassie_core_sim_free',
    'radio_out_t', 'cassie_core_sim_step', 'cassie_core_sim_t',
    'struct_c__SA_elmo_out_t', 'cassie_core_sim_setup',
    'udp_init_host', 'wait_for_packet', 'vectornav_out_t',
    'struct_c__SA_packet_header_info_t', 'struct_c__SA_battery_out_t',
    'struct_c__SA_target_pc_out_t', 'struct_c__SA_cassie_pelvis_in_t',
    'struct_c__SA_cassie_in_t', 'process_packet_header', 'size_t',
    'target_pc_out_t', 'cassie_leg_out_t', 'cassie_pelvis_out_t',
    'cassie_leg_in_t', 'cassie_in_t', 'elmo_in_t',
    'packet_header_info_t', 'get_newest_packet', 'battery_out_t',
    'cassie_joint_out_t', 'radio_in_t',
    'struct_c__SA_cassie_user_in_t', 'DiagnosticCodes',
    'unpack_cassie_user_in_t', 'struct_sockaddr',
    'unpack_cassie_out_t', 'cassie_core_sim_alloc',
